...
if (!recentHeadlines || recentHeadlines.trim().split(”\n”).length < 3) return null;
const prompt = [
...
const refusal = [“I cannot”, “I can’t”, “does not contain”, “no specific”, “not enough”, “insufficient”, “unable to”, “no recent”, “provided headline”];
if (!text || refusal.some(p => text.toLowerCase().includes(p.toLowerCase()))) return null;
return text;
} catch { return null; }
}
